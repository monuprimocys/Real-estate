...
function AdvanceSerach() {
  ...
  const handleChangebedroomsDropDwon = (event) => {
    ...
    console.log("Selected Bedrooms ID:", selectedId);
  };
  ...
  const handleChangebathroomsDropDwon = (event) => {
    ...
    console.log("Selected Bathrooms ID:", selectedId);
  };
  ...
  const handleChangePropertyTypeDropDwon = (event) => {
    ...
    console.log("Selected Property Type ID:", selectedId);
  };
  ...
  const handleChangeSortbyDropDwon = (event) => {
    ...
    console.log("Selected Sortby ID:", selectedId);
  };
  ...
  const handleChangeGarageDropDwon = (event) => {
    ...
    console.log("Selected Garage ID:", selectedId);
  };

  // minimum price input value
  const handleInputChangeMinimuePrice = (event) => {
    setMinimumPrice(event.target.value);
  };

  // maximum price input value
  const handleInputChangeMaximumPrice = (event) => {
    setMaximumPrice(event.target.value);
  };

  // minimum area input value
  const handleInputChangeMinimumArea = (event) => {
    setMinimumArea(event.target.value);
  };

  // maximum area input value

  const handleInputChangeMaximumArea = (event) => {
  ...
  const toggleFilter = useCallback((id) => {
    setActiveFilters((prevFilters) => {
      ...
      console.log("Selected Feature IDs2222:", updatedFilters);
    ...
    try {
      ...
      if (response_code === "1") {
        if (filter_property?.length) {
          console.log("Filtered properties:", filterAllDropDownResponse);
          ...
          console.log("Store reset: no properties found.");
        }
        ...
        dispatch(reset_filters());
        console.log("Store reset for response_code 0.");
      } else {
  ...
  console.log("thwe values of the selected id status", active);
          ...
          <div className="w-full">
            ...
            <div className="relative flex items-center mt-2 ">
              ...
              <input
                ...
                onChange={handleInputChangeMinimuePrice}
              />
            </div>
          </div>
          ...
          <div className="w-full">
            ...
            <div className="relative flex items-center mt-2 ">
              ...
              <input
                ...
                onChange={handleInputChangeMaximumPrice}
              />
            </div>
          </div>
          <div className="xl:w-full">
          ...
          <div className="w-full">
            ...
            <div className="relative flex items-center mt-2">
              <input
                ...
                onChange={handleInputChangeMinimumArea}
              />
              <div className="absolute right-0 top-0 bottom-0 flex items-center bg-[#B5843D36] rounded-lg justify-between  py-1 ">
                ...
                <span className="absolute transform -translate-y-1/2 right-3 top-1/2">
                  <img src={areicon} alt="Dropdown Icon" className="w-4 h-4" />
                </span>
              </div>
            </div>
          </div>
          ...
          <div className="w-full">
            ...
            <div className="relative flex items-center mt-2">
              <input
                ...
                onChange={handleInputChangeMaximumArea}
              />
              <div className="absolute right-0 top-0 bottom-0 flex items-center bg-[#B5843D36] rounded-lg justify-between  py-1 ">
                <select
                  id="MinAreaUnit"
        ...
        <div className="flex flex-col flex-wrap justify-between w-full mt-10 gap-y-6">
          ...
          <div className="flex flex-wrap items-center w-full gap-8">
            {features.map((feature) => (
              <div
                key={feature.id}
                className={`flex items-center justify-center px-6 py-2 w-fit rounded-lg fontpoppins ${
