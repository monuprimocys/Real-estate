  ...
  return (
    <div className="flex items-center justify-between px-4 ">
      ...
      <div className="flex justify-center flex-grow px-1">
        <h1 className="text-2xl font-extrabold text-center md:text-3xl xl:text-5xl Bostonfont ">
          {title}{" "}
          <span className=" text-[#B5843F] md:text-3xl   xl:text-5xl  Bostonfont font-extrabold ">
            {highlightedTitle}
          </span>
        </h1>
      </div>
