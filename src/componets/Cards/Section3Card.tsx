    ...
    <div className="overflow-hidden bg-white rounded-[1.2rem] shadow-xl sm:w-[25rem] md:w-[45rem] lg:w-[28rem] xl:w-[32rem] 2xl:w-[25rem] group">
      ...
      <div className="relative">
        <div className="overflow-hidden">
          <img
            className="object-cover w-full transition-transform duration-500 ease-in-out transform h-52 sm:h-60 group-hover:scale-110"
            src={mainImage}
            alt={title}
          />
        </div>
      ...
      <div className="flex flex-col p-4 space-y-3">
        ...
        <div className="flex items-center gap-2">
          ...
          <p className="text-sm text-[#000000] Bostonfont font-normal line-clamp-1">
            {location}
          </p>
        </div>
        ...
        <div className="flex flex-wrap items-center justify-between mt-2 space-y-2 md:space-y-0">
          ...
          <div className="flex space-x-3">
            ...
            <button className="flex items-center px-3 py-1 text-sm text-[#056CB2] border Bostonfont border-[#056CB2] rounded-md space-x-1 hover:bg-[#bacad4] transition-colors">
